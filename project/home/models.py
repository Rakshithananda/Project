...
#     village_code = models.IntegerField("Village Code",limi)
#     mandal_code = CompositeForeignKey(Revenue_Mandal,on_delete = models.CASCADE,to_fields={'mandal_code','dist_code'})
